...
La prima scelta è stata il nero. Non come sfondo su cui proiettare qualcosa, ma come ambiente in cui qualcosa esiste. C'è una differenza: lo sfondo è passivo, è ciò che c'è quando non c'è nient'altro. L'ambiente è attivo, è la condizione che rende possibile quello che contiene.
...
C'è anche una ragione storica per questa scelta. Gran parte dell'arte che lavora con la luce, da James Turrell a Bruce Nauman, usa il buio come condizione. Il buio non è assenza: è presenza di un tipo diverso, più ricettiva, più attenta. Crea una qualità di percezione diversa rispetto alla luce ordinaria.
