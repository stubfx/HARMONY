...
Il limite più evidente è nella qualità dell'ascolto. Il sistema percepisce il volume ambientale della stanza, ma non distingue i suoni. Non sa se quello che sente è musica, conversazione, applauso, o silenzio improvviso. Risponde alla quantità di suono, non alla sua qualità. Questo produce effetti interessanti, ma limita molto la gamma di risposte possibili: il sistema non può reagire diversamente a una risata collettiva e a un rumore di sottofondo casuale.

Una limitazione simile riguarda la visione. Il sistema non vede la stanza. Non sa quante persone ci sono, dove sono posizionate, se si stanno muovendo o stanno ferme. L'unico canale di informazione sul comportamento fisico dei partecipanti è il telefono. Questo lascia fuori gran parte di ciò che un corpo fa in uno spazio: la postura, il movimento, la direzione dello sguardo, la distanza dagli altri.
...
Il progetto è stato pensato per una sala di dimensioni moderate, con un numero limitato di partecipanti. A questa scala, il sistema funziona: c'è abbastanza partecipazione da produrre dinamiche collettive interessanti, e abbastanza controllo da gestire la connessione in tempo reale.
...
Questo potrebbe essere bellissimo. Oppure soverchiante, nell'accezione negativa del termine: qualcosa che non lascia spazio all'individuo, che annulla invece di includere. La differenza tra questi due esiti dipende da scelte di design che a questa scala non sono ancora state fatte. È una domanda aperta.
