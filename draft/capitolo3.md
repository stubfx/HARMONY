...
Il colore personale rimane visibile nello sciame anche quando ci sono molti partecipanti. Si mescola, si attenua, cambia in relazione agli altri. Ma c'è. È la traccia di una presenza individuale all'interno di un corpo collettivo. Ed è, in qualche modo, il punto centrale di tutta l'esperienza: capire che si può essere parte di qualcosa di più grande senza dissolversi completamente in esso. Che l'identità non sparisce nella folla, ma continua a esistere come colore, come direzione, come impulso.
