...
Altre cose sono emerse durante il lavoro e si sono rivelate centrali. La reattività al suono, per esempio, non era nel piano iniziale, ed è nata da una domanda semplice, cosa succederebbe se il sistema sentisse la stanza, cambiando in modo profondo la qualità dell'esperienza.
...
Questa circolarità è al centro di molte delle domande più interessanti aperte dalla tecnologia computazionale negli ultimi decenni. Non interessa qui chi sia più intelligente, l'umano o la macchina, ma come si trasforma la relazione tra i due quando il sistema è abbastanza complesso da rispondere in modi non del tutto prevedibili.
...
Alan Turing, nel saggio del 1950 *Computing Machinery and Intelligence*, si chiedeva se si potesse mai distinguere, in una conversazione, una risposta umana da una risposta di macchina. La sua domanda riguardava la simulazione del linguaggio, ma la struttura del problema vale anche qui, perché quando non si riesce più a distinguere quali parti del comportamento del sistema vengono dai partecipanti e quali dalla sua logica interna, diventa difficile dire chi stia guidando.
...
Questa trasformazione ha un effetto preciso, perché rende osservabile quello che di solito si sente soltanto. Si può avere la sensazione di far parte di un gruppo coeso o di un gruppo disperso, e con questo sistema quella sensazione prende una forma visiva. La si può vedere.
...
Le sfide tecniche di questa espansione sono reali ma risolvibili, mentre quelle concettuali sono più interessanti. Con mille partecipanti le dinamiche collettive cambierebbero natura, si formerebbero sottogruppi, emergerebbero strutture di influenza più complesse, e la logica dello sciame diventerebbe ancora più evidente e meno controllabile. Il singolo si sentirebbe ancora meno un agente di controllo e ancora di più parte di qualcosa che lo supera.
