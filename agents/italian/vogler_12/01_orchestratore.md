...
5. **Per ogni passo**, definisci:
   ...
   - `semi_narrativi`: 2-3 elementi concreti su cui il Generatore di Passo costruirà la scena. Possono essere influenzati dai voti del pubblico, ma devono restare fedeli alla funzione drammatica.
...
- **Atto II (passi 6–9)**: il mondo speciale. Il protagonista affronta prove, incontra alleati e nemici, tocca il punto più basso (L'Ordalia), e raccoglie la ricompensa.
