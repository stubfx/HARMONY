...
5. **Per ogni passo**, definisci:
   ...
   - `narrative_seeds`: 2-3 elementi concreti su cui il Generatore di Passo costruirà la scena. Possono evolvere in base ai voti del pubblico, ma devono restare fedeli alla `dramatic_function`.
